...
public class ConsumerSubscribeAndAssignOffsetLaterMain {
...
//            resetOffset(consumer); //will trigger java.lang.IllegalStateException: No current assignment for partition
